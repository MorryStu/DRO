...
Serial.print(measured_value,2); Serial.println(" mm"); 
 ...
 tft.invertDisplay(false);
  ...
  tft.setTextSize(1);
  tft.print("Angle");
  tft.drawRect(0, 0, 320, 46, ST77XX_YELLOW);
  tft.drawRect(0, 50, 320, 46, ST77XX_RED);
  tft.drawRect(0, 98,320, 46, ST77XX_GREEN);
  tft.drawRect(0, 142, 320, 46, ST77XX_MAGENTA);
  tft.drawRect(0, 190, 320,46, ST77XX_WHITE);
  //tft.setTextSize(1);
  //tft.setFont(&FreeMonoBoldOblique12pt7b);
  //tft.setCursor(20, 180);
  //tft.print("Cutting Depth MM ");
//delay(100);
}
